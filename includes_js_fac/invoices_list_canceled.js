//invoices_list_canceled.js
$(document).ready(function() {
    $('#icons').load('http://cdcom.dynalias.com/facturalion2/includes_php_fac/getdata_invoices_list_canceled.php');
...
function save_selection_item(idgral){
  $.ajax({
	...
	if(data.result == "Ok!"){
      window.location ="invoices_consult_invoice_canceled.html";
	} else {
